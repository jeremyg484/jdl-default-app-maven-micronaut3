...
public class BankAccount implements Serializable {
    ...
    public void setBanks(Set<Bank> banks) {
        if (this.banks != null) {
            this.banks.forEach(i -> i.removeBankAccount(this));
        }
        if (banks != null) {
            banks.forEach(i -> i.addBankAccount(this));
        }
        this.banks = banks;
    }

    public BankAccount banks(Set<Bank> banks) {
        this.setBanks(banks);
        return this;
    }

    public BankAccount addBank(Bank bank) {
        this.banks.add(bank);
        bank.getBankAccounts().add(this);
        return this;
    }

    public BankAccount removeBank(Bank bank) {
