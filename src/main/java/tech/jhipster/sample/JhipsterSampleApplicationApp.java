...
import tech.jhipster.sample.config.DefaultProfileUtil;

@OpenAPIDefinition(info = @Info(title = "jhipsterSampleApplication", version = "0.0", description = "jhipsterSampleApplication API"))
