...
describe('TheLabel Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'the-label', component: TheLabelComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.theLabels?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
