...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const chores: ITask = { id: 88679 };
      job.chores = [chores];
      const emp: IEmployee = { id: 21743 };
      job.emp = emp;
      ...
      expect(comp.tasksSharedCollection).toContain(chores);
      expect(comp.employeesSharedCollection).toContain(emp);
    });
  });
