...
public class OperationResourceIT {
    ...
    public void createOperationWithExistingId() throws Exception {
        ...
        HttpResponse<Operation> response = client
            .exchange(HttpRequest.POST("/api/operations", operation), Operation.class)
            .onErrorReturn(t -> (HttpResponse<Operation>) ((HttpClientResponseException) t).getResponse())
            .blockingFirst();
    ...
    public void getAllOperations() throws Exception {
        ...
        List<Operation> operations = client
            .retrieve(HttpRequest.GET("/api/operations?eagerload=true"), Argument.listOf(Operation.class))
            .blockingFirst();
    ...
    public void getNonExistingOperation() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<Operation> response = client
            .exchange(HttpRequest.GET("/api/operations/" + Long.MAX_VALUE), Operation.class)
            .onErrorReturn(t -> (HttpResponse<Operation>) ((HttpClientResponseException) t).getResponse())
            .blockingFirst();
    ...
    public void updateOperation() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<Operation> response = client
            .exchange(HttpRequest.PUT("/api/operations/" + operation.getId(), updatedOperation), Operation.class)
            .onErrorReturn(t -> (HttpResponse<Operation>) ((HttpClientResponseException) t).getResponse())
            .blockingFirst();
    ...
    public void updateNonExistingOperation() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<Operation> response = client
            .exchange(HttpRequest.PUT("/api/operations/" + operation.getId(), operation), Operation.class)
            .onErrorReturn(t -> (HttpResponse<Operation>) ((HttpClientResponseException) t).getResponse())
            .blockingFirst();
    ...
    public void deleteOperation() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpResponse<Operation> response = client
            .exchange(HttpRequest.DELETE("/api/operations/" + operation.getId()), Operation.class)
            .onErrorReturn(t -> (HttpResponse<Operation>) ((HttpClientResponseException) t).getResponse())
            .blockingFirst();
