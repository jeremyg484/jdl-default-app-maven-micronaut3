...
Specifically, this application was generated using the [`jdl-default-app.jdl`](https://github.com/jeremyg484/generator-jhipster-micronaut/blob/micronaut-3-fixes/test-integration/samples/jdl-default-app.jdl). 

From a from a new directory parallel to the generator-jhipster-micronaut cloned repository, the following commands were executed:
```
